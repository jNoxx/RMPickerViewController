Pod::Spec.new do |s|
  ...
  s.public_header_files  = 'RMPickerViewController/RMPickerViewController.h', 'RMPickerViewController/RMActionController/RMActionControllerAppearance.h', 'RMPickerViewController/RMActionController/RMActionController.h', 'RMPickerViewController/RMActionController/Actions/RMAction.h', 'RMPickerViewController/RMActionController/Actions/RMImageAction.h', 'RMPickerViewController/RMActionController/Grouping Actions/RMGroupedAction.h', 'RMPickerViewController/RMActionController/Grouping Actions/RMScrollableGroupedAction.h'
  s.requires_arc = true
end
